    ...
    <div class="container-sm mt-5">
        <div class="card shadow mx-auto" style="max-width: 480px;">
            <div class="card-header bg-primary text-white text-center">
                <h4 class="mb-0">Subir archivo CSV de Vacaciones</h4>
            </div>
            <div class="card-body">
                <form method="post" action="../Controllers/cargarVacaciones.php" enctype="multipart/form-data" id="formulario">
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="../Controllers/generaCSVVacaciones.php" class="btn btn-outline-primary">Descargar plantilla</a>
